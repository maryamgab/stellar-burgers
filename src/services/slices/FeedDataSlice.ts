...
import { fetchFeedApi } from '../../utils/burger-api';
import { TOrder } from '@utils-types';
import { fetchOrderByNumberApi } from '../../utils/burger-api';
...
export const getFeedData = createAsyncThunk('feed/data', fetchFeedApi);
