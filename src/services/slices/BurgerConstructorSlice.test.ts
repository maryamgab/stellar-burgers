...
describe('Constructor slice tests ', () => {
  ...
  it('addIngredient should add ingredient into constructor', () => {
    ...
    expect(newState.burgerItems.ingredients).toHaveLength(1);
    expect(newState.burgerItems.ingredients[0]).toEqual({
      ...ingredient1,
  ...
  it('addIngredient should add bun into constructor', () => {
    ...
    expect(newState.burgerItems.bun).toEqual({
      ...bun,
  ...
  it('moveUpIngredient should MOVE UP ingredient within constructor', () => {
    ...
    expect(newState.burgerItems.ingredients[1]).toEqual({
      ...ingredient1,
      id: expect.any(String)
    });
  });
  ...
  it('clearOrder should clear constructor', () => {
    ...
    expect(newState.burgerItems.bun).toBeNull();
    expect(newState.burgerItems.ingredients).toHaveLength(0);
  });
});
